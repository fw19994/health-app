...
class _FamilyFinanceScreenState extends State<FamilyFinanceScreen> {
  ...
  final List<FamilyMember> _familyMembers = [
    FamilyMember(
      ...
      contribution: 4730.25,
      contributionPercentage: 55.4,
    ),
    FamilyMember(
      name: '王丽',
      relation: '配偶',
      avatarUrl: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80',
      contribution: 3800.20,
      contributionPercentage: 44.6,
    ),
  ];
  ...
  Widget _buildHeader() {
    ...
    // 计算月度总支出
    double totalExpense = 8530.45;
    double budget = 12000.00;
    double remaining = budget - totalExpense;
    int usedPercentage = ((totalExpense / budget) * 100).round();
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Container(
                        height: 6,
                        width: MediaQuery.of(context).size.width * usedPercentage / 100 - 64,
                        decoration: BoxDecoration(
                          color: Colors.white,
                          borderRadius: BorderRadius.circular(3),
                        ),
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  // 贡献金额和百分比
                  Text(
                    '¥${member.contribution.toStringAsFixed(2)} (${member.contributionPercentage.toStringAsFixed(1)}%)',
                    style: const TextStyle(
                      fontSize: 14,
                      fontWeight: FontWeight.w500,
                      color: Color(0xFF1F2937),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Container(
                      height: 6,
                      width: MediaQuery.of(context).size.width * member.contributionPercentage / 100 - 100,
                      decoration: BoxDecoration(
                        color: color,
                        borderRadius: BorderRadius.circular(3),
                      ),
